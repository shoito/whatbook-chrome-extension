...
module.exports = (grunt) ->
  ...
  grunt.registerTask "build", ["clean:dist", "copy:jquery", "prepareManifest", "useminPrepare", "concurrent:dist", "concat", "uglify", "copy:coffee", "copy:dist", "usemin", "manifest", "compress"]
